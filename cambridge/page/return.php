...
<?php
    $html_title = array('zh-tw'=>'歸還耗材', 'en'=>'Return Supplies');
        ...
        <div class="content">
            <div class="table-style">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                                ...
                                $DB = new db();
                                $apply = 1; 
                                $sql = "SELECT io.ioid, io.dt, u.name username, c1.catid main, c2.catid sub, c1.name parent, c2.name, o.item, o.size, o.color, o.unit, io.num FROM Category c1, Category c2, Object o, objectAndCat oc, inAndOut io, Userinfo u WHERE c2.catid = oc.catid AND o.oid = oc.oid AND c1.catid = c2.parent AND o.oid = io.oid AND io.aid = $apply AND o.ret = 1 AND io.get = 1 AND io.ret = 0 AND io.uid = u.uid";
                                ...
                                foreach ($result as $r) {
                                    ...
                                    echo "<tr class='td-".$r['sub']."'>
                                            <td data-title='".$ret3[$lang]."'><input type='checkbox' class='ck-box' id='io-".$r['ioid']."'></td>
                ...
                <div class="d-flex justify-content-center py-4">
                    <button id="return" class="btn submit-btn btn-primary" type="submit"><?php echo $submit[$lang]; ?></button>
                </div>
            </div>
        </div>
    </div>
