...
<nav class="navbar navbar-expand-lg navbar-light bg-white px-5 main-nav sticky-top mb-6 admin">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerNav">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            <li class="nav-item dropdown mr-5">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><?php echo $multistr1[$lang]; ?></a>
                <div class="dropdown-menu">
                    <a class="dropdown-item py-2" href="remaining.php"><?php echo $multistr2[$lang]; ?></a>
                    <a class="dropdown-item py-2" href="condition.php"><?php echo $multistr3[$lang]; ?></a>
                    <a class="dropdown-item py-2" href="applying.php"><?php echo $multistr4[$lang]; ?></a>
                    <a class="dropdown-item py-2" href="purchase.php"><?php echo $multistr5[$lang]; ?></a>
                </div>
            </li>
            <li class="nav-item dropdown mr-5">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><?php echo $multistr6[$lang]; ?></a>
                <div class="dropdown-menu">
                    <a class="dropdown-item py-2" href="supply.php"><?php echo $multistr7[$lang]; ?></a>
                    <a class="dropdown-item py-2" href="modifysupply.php"><?php echo $multistr8[$lang]; ?></a>
                    <a class="dropdown-item py-2" href="get.php" role="button"><?php echo $multistr17[$lang]; ?></a>
                    <a class="dropdown-item py-2" href="return.php" role="button"><?php echo $multistr18[$lang]; ?></a>
                </div>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><?php echo $multistr9[$lang]; ?></a>
                <div class="dropdown-menu">
                    <a class="dropdown-item py-2" href="createuser.php"><?php echo $multistr10[$lang]; ?></a>
                    <a class="dropdown-item py-2" href="modifyuser.php"><?php echo $multistr11[$lang]; ?></a>
                    <a class="dropdown-item py-2" href="limit.php"><?php echo $multistr15[$lang]; ?></a>
                    <a class="dropdown-item py-2" href="reset.php"><?php echo $multistr20[$lang]; ?></a>
                </div>
            </li>
        </ul>
    </div>
    <div class="collapse navbar-collapse user-list" id="navbarTogglerUser">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="newsemester.php"><?php echo $multistr21[$lang]; ?></a>
            </li>
            <div class="dropdown-divider"></div>
            <li class="nav-item">
    ...
    <div class="nav-item dropdown user-list-lg">
        ...
        <div class="dropdown-menu">
            ...
            <div class="dropdown-divider"></div>
            <a href="newsemester.php" class="dropdown-item py-2"><?php echo $multistr21[$lang]; ?></a>
            <div class="dropdown-divider"></div>
