<nav class="sidebar">
    ...
    <div class="py-4 border-bottom">
        <input type="text" id="from" class="input-box form-control mb-3" placeholder="<?php echo $smulti2[$lang]; ?>" required>
        <input type="text" id="to" class="input-box form-control" placeholder="<?php echo $smulti3[$lang]; ?>" required>
    </div>
